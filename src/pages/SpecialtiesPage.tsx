...
const SpecialtiesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      {/* Hero Section */}
      <div className="relative w-full bg-gradient-to-r from-[#007E85] to-[#007E85]/80 py-20 text-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <Link to="/find-doctors">
            <Button className="bg-white text-[#007E85] hover:bg-gray-100 shadow-lg">
              Book a Consultation
            </Button>
          </Link>
        </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#007E85] mb-10 text-center">
            Our Specialties
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {specialties.map((specialty) => (
              <Link key={specialty.id} to={specialty.href} className="group">
                <Card className="hover:shadow-2xl transition-all duration-300 hover:-translate-y-3 border-[#007E85]/20 overflow-hidden h-full">
                  <CardHeader className="p-6 text-center bg-gradient-to-b from-[#007E85]/10 to-white">
                    <div className="w-20 h-20 bg-[#007E85]/10 rounded-full flex items-center justify-center mx-auto mb-6 transition-transform group-hover:scale-110">
                      <Stethoscope className="h-10 w-10 text-[#007E85]" />
                    </div>
                    <CardTitle className="text-2xl text-[#007E85] font-semibold">
                      {specialty.name}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="p-6 pt-0">
                    ...
                    <div className="text-center">
                      <Button className="bg-gradient-to-r from-[#007E85] to-[#007E85]/80 hover:from-[#006A6F] hover:to-[#006A6F]/80 text-white shadow-md hover:shadow-lg transition-all duration-200">
                        Explore Now
                      </Button>
                    </div>
                  </CardContent>
